        ...
        <div className='special-grid-100 items-center justify-between px-4 py-2 border-b border-clr-100'>
            ...
            <div className=' flex gap-2 items-center justify-between'>
                <div className='flex items-center gap-2'>
                    ...
                    <select value={file?.convertTo || '...'} onChange={(e) => {setImageFormatTo(file.id, e.target.value, setFiles)}} className='rounded-sm text-clr-300 px-1.5 py-1.5 outline outline-clr-100 focus:outline-2 focus-within:outline-2 uppercase'>
